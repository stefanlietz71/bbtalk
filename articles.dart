...
import 'package:bbtalk_app/models/Article.dart';
import 'package:bbtalk_app/pages/single_Article.dart';
import 'package:bbtalk_app/widgets/articleBox.dart';
import 'package:bbtalk_app/widgets/articleBoxFeatured.dart';
...
class _ArticlesState extends State<Articles> {
  ...
  Future<List<dynamic>> fetchLatestArticles(int page) async {
    try {
      ...
      throw 'Keine Internet Verbindung';
    }
    return latestArticles;
  }
          ...
          return Column(
            children: <Widget>[
              Column(
                ...
                final heroId = item.id.toString() + "-Aktuellste";
                return InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
      ...
      child: FutureBuilder<List<dynamic>>(
        ...
        builder: (context, articleSnapshot) {
          if (articleSnapshot.hasData) {
            ...
            return Row(
                children: articleSnapshot.data!.map((item) {
              final heroId = item.id.toString() + "-Favoriten";
              return InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
            ...
            return Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text("Keine Internet Verbindung"),
                  TextButton.icon(
